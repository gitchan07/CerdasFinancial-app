        ...
        <div className="bg-gray-100">
            ...
            >
                <div className="mx-auto max-w-[600px]">
                    <div className="text-center">
                        <h1 className="text-shadow mb-4 text-4xl font-semibold text-white">
                            Cerdas Financial, a More Secure Future!
                        </h1>
                        <p className="text-shadow mb-8 text-lg text-gray-100">
            ...
            <main>
                <section className="container mx-auto py-20">
                    <h2 className="text-shadow-sm text-center text-2xl font-bold text-blue-600 shadow-blue-100">
                        Why Important?
                    </h2>
                    ...
                    <div className="mt-10 flex flex-wrap items-stretch justify-evenly">
                        <div className="max-w-96 rounded-md bg-white p-4 shadow-lg">
                            ...
                            <p className="mt-2 text-gray-600">
                                Many people have difficulty budgeting, saving,
                                or managing debt wisely.
                            </p>
                        </div>
                        <div className="max-w-96 rounded-md bg-white p-4 shadow-lg">
                            <h3 className="text-xl font-semibold text-gray-900">
                        ...
                        <div className="max-w-96 rounded-md bg-white p-4 shadow-lg">
                            <h3 className="text-xl font-semibold text-gray-900">
                                Lack of Easy-to-Understand Financial Education
                            </h3>
                            <p className="mt-2 text-gray-600">
                ...
                <section className="container mx-auto py-20">
                    <h2 className="text-shadow-sm mb-4 text-center text-2xl font-bold text-blue-600 shadow-blue-100">
                        Pricing
                    </h2>
                    ...
                    <p className="text-center text-gray-600">
                        Pariatur laborum dolor ea commodo sit aute aliquip qui
                        et cillum excepteur.
                    </p>
